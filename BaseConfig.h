...
// Push notifications
#define  NOTIFICATION_APP "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
#define  NOTIFICATION_USER "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"  // This can be a group or user

//Action URL access
//Comment out username if no authentication
#define ACTION_USERNAME "user"
